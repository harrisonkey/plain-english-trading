...
export default async function handler(req, res) {
  ...
  const TICKERS = [
    ...
    // Small tech
    'SOUN','IONQ','BTDR','BBAI','CXAI','MIND','PRCT','AMBA','VZIO','REAX',
    // Biotech
    'ARDX','PRAX','VKTX','RXRX','BEAM','IMVT','ARQT','NRIX','TGTX','CRSP',
    // Materials
    'MP','UUUU','NXE','LAC','LITM','WOLF','GATO','CDE','HL','USAS',
    // Financials
    'UWMC','RKT','PFSI','COOP','GHLD','OPFI','LPRO','ATLC','ENVA','PRAA',
    // Tech hardware
    'SMCI','AEHR','FORM','VICR','DIOD','AOSL','SITM','ALGM','AAOI','SWKS',
    // Clean energy
    'ARRY','SHLS','STEM','NOVA','FLUX','CLNE','AMRC','HASI','MAXN','SPWR',
    // Consumer
    'PRPL','CATO','GIII','XPOF','BOWL','COOK','RENT','LOVE','CURV','PTGX',
  /*PLACEHOLDER*/
